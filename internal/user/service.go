...
type Service interface {
	...
	Register(ctx context.Context, user *models.UserCreate) (*models.User, error)
	...
	UpdateUserById(ctx context.Context, userID string, user *models.UserUpdate) (*models.UserView, error)
