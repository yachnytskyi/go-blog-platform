...
func PostCreateToPostCreateRepositoryMapper(post *PostCreate) PostCreateRepository {
...
func PostUpdateToPostUpdateRepositoryMapper(post *PostUpdate) PostUpdateRepository {
