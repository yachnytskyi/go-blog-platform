...
func (x *LoginUserView) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginUserView) ProtoMessage() {}

func (x *LoginUserView) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_login_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginUserView.ProtoReflect.Descriptor instead.
func (*LoginUserView) Descriptor() ([]byte, []int) {
	return file_rpc_login_user_proto_rawDescGZIP(), []int{1}
}

func (x *LoginUserView) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *LoginUserView) GetAccessToken() string {
	if x != nil {
...
func (x *LoginUserView) GetRefreshToken() string {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x3d, 0x0a,
	...
	0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x56, 0x69, 0x65, 0x77, 0x12, 0x16, 0x0a,
	...
	0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x4f, 0x5a,
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	(*LoginUser)(nil),     // 0: model.LoginUser
	(*LoginUserView)(nil), // 1: model.LoginUserView
}
